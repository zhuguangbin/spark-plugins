...
import org.apache.hadoop.mapreduce.{RecordReader => newRecordReader, TaskType, InputFormat => newInputClass, JobID => newJobID, TaskAttemptID => newTaskAttemptID, TaskID => newTaskID}
import org.apache.hadoop.util.ReflectionUtils
import org.apache.spark.TaskContext
import org.apache.spark.broadcast.Broadcast
import org.apache.spark.internal.Logging
import org.apache.spark.sql.ImplicitHelper.{SparkConfHelper, SparkContextHelper, StructTypeHelper}
import org.apache.spark.sql.InternalBridge.Config.{IGNORE_CORRUPT_FILES, IGNORE_MISSING_FILES}
import org.apache.spark.sql.InternalBridge.{NextIterator, shutdownHookManager, sparkUtil}
